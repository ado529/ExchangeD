...
<body class="bg-purple-500">
  <form action="user_login_act.php" method="POST">
    <fieldset class="text-center font-semibold">
      ...
      <p class="text-2xl text-white tracking-wider p-2">ログインして下さい</p>
      ...
      <div class="p-5">
        <button class="shadow-lg px-2 py-1  bg-purple-300 text-lg text-white font-semibold rounded  hover:bg-purple-700 hover:shadow-sm hover:translate-y-0.5 transform transition">　　Login　　</button>
      </div>
      <p class="text-white tracking-wider p-3">or</p>
      <a href="user_register.php"><span class="shadow-lg px-2 py-1  bg-purple-300 text-lg text-white font-semibold rounded  hover:bg-purple-700 hover:shadow-sm hover:translate-y-0.5 transform transition">　　register　　</span></a>
    </fieldset>
  </form>
