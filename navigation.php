...
<body class="bg-white">
  ...
  <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
    <div class="text-sm lg:flex-grow">
      <a href="exchanged_input.php" class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">HOME</a>
      <a href="未user_ajax.php" class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">一覧</a>
      <a href="ajax_search.html" class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white">検索</a>
    </div>
    <div>
